@livewire('tall-report::admin.operacional.reports.includes.filters-component', compact('model'), key(sprintf('filters-%s', $model->id)))
@livewire('tall-report::admin.operacional.reports.includes.ordering-component', compact('model'), key(sprintf('ordering-%s', $model->id)))
