                ...
                <th scope="col" class="text-sm w-full font-medium text-gray-900 px-6 py-2 border-r-2 border-white">
                    <div class="flex justify-between items-center min-w-full">
                        ...
                        <div class="flex space-x-2 items-center w-20 justify-end">
                            @if ($column = $items)
                                @livewire('tall-report::admin.operacional.reports.includes.column-component', compact('column', 'name', 'model'), key(sprintf('column-%s', $items)))
                            @endif
                        ...
                        @if ($column = $item)
                            <th scope="col"
                                ...
                                <div class="flex justify-between items-center space-x-1">
                                    ...
                                    <div class="flex space-x-2 items-center  w-20 justify-end">
                                        @livewire('tall-report::admin.operacional.reports.includes.column-component', compact('column', 'name', 'model'), key(sprintf('column-item-%s', $item)))
